...
public class Database extends ContentProvider {
	...
	public static final String AUTHORITY = "cz.destil.feelings.provider";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case FEELINGS:
			return db.query(FEELINGS_TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
		default:
	...
	public synchronized int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
		...
		switch (match) {
		case FEELING:
			affected = db.update(FEELINGS_TABLE_NAME, values, Feelings._ID + "=" + uri.getPathSegments().get(1), null);
			break;
		case FEELINGS:
	...
	public synchronized int delete(Uri uri, String where, String[] whereArgs) {
		...
		switch (match) {
		case FEELING:
			affected = db.delete(FEELINGS_TABLE_NAME, Feelings._ID + "=" + uri.getPathSegments().get(1), null);
			break;
		case FEELINGS:
